...
exports.commands = {
	...
	shop: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			'<tr><td>TC</td><td>Compra una Tarjeta de Entrenador personalizada (a partir de código html). Contactar con un administrador si el código es muy largo para un solo mensaje.</td><td>8000</td></tr>' +
			'<tr><td>Avatar</td><td>Compra un avatar personalizado. Preferiblemente debe ser una imagen de pequeñas dimensiones y acorde a las reglas del servidor. Contactar con un Admin para obtener este art&iacute;culo.</td><td>6400</td></tr>' +
			...
			'<tr><td>Arreglo de Avatar</td><td>Si ya tienes un avatar personalizado. Puedes cambiarlo por otro diferente.</td><td>1000</td></tr>' +
			'<tr><td>Icono</td><td>Compra un icono de un pokemon al lado de tu nick para 3 salas. Debe ser una imagen 32x32. Contactar con un Admin para obtener este artículo.<br><b>OJO:Tu icono puede durar hasta 32 Horas en aparecer</td><td>2500</td></tr>' +
