...
function create_table() {
	...
	return "<div class='infobox'><div class = 'broadcast-blue'><center><b><u>Lista de Emoticones del Servidor</u></b></center>" + "<div class='infobox-limited'><table cellspacing='0' cellpadding='5' width='100%'>" + "<tbody>" + emotes_group_list.join("") + "</tbody>" + "</table></div></div>";
}
